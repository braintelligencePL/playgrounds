...
*  `val adder: (Int, Int) -> Double = { a, b -> (a + b).toDouble() }` - czasami lepszy sposób na to samo.
*  `adder(1,1)` - po czym robimy skomplikowane obliczenia. Wynik jest zmienno-przecinkowy jak się można domyślić.
